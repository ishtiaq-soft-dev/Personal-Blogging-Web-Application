...
def create_app(config_class=Config):
    ...
    from src.extensions import db, bcrypt, login_manager, csrf
    db.init_app(app)
    bcrypt.init_app(app)
    ...
    # Register blueprints
    from src.routes import admin_bp, public_bp
    ...
    def inject_categories():
        from src.models import Category, Tag, UserRole
        from src.utils import time_ago, get_avatar_initials
        return dict(
